  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <span className="text-2xl md:text-3xl font-normal text-primary/90 tracking-tight">
          1.1K
        </span>
        <span className="text-[10px] md:text-[12px] font-normal text-primary/60 uppercase tracking-wider">
          Satisfied Clients
        </span>
      </div>
      ...
      >
        <div className="bg-primary/10 p-1 rounded-full flex items-center justify-center">
          <ArrowUpRight className="w-4 h-4 text-primary/90" />
        </div>
        <span className="text-[14px] font-normal text-primary/90">
          Contact Us
        </span>
      </motion.button>
    </motion.div>
