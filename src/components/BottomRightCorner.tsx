...
export default function BottomRightCorner() {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.99 }}
      className="absolute bottom-0 right-0 p-3 pt-5 pl-8 sm:p-4 sm:pt-6 sm:pl-10 md:p-6 md:pt-8 md:pl-14 bg-[#f0f0f0] hover:bg-[#e5e5e5] cursor-pointer transition-all duration-300 rounded-tl-[1.5rem] sm:rounded-tl-[2rem] md:rounded-tl-[3.5rem] flex items-center gap-3 sm:gap-4 md:gap-6 group"
    >
