        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center">
          ...
          <div className="w-full flex flex-col items-center pt-8 px-6 text-center max-w-4xl">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-[80px] font-normal text-muted-foreground mb-2 tracking-tight leading-[1.05]"
            >
            ...
            <motion.p
              ...
              className="text-sm sm:text-base md:text-lg text-primary/900 opacity-80 leading-relaxed max-w-xl font-normal"
            >
